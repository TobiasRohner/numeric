...
if (NUMERIC_HIP_REQUIRE_DOWNLOAD)
  ...
  elseif(HIP_PLATFORM STREQUAL "nvidia")
    ...
    set(CMAKE_HIP_FLAGS "${CMAKE_HIP_FLAGS} -DNUMERIC_ENABLE_HIP=1 -D__HIP_PLATFORM_NVIDIA__ -I ${CUDAToolkit_INCLUDE_DIRS}")
    if(CMAKE_BUILD_TYPE STREQUAL "Debug")
      set(CMAKE_HIP_FLAGS "${CMAKE_HIP_FLAGS} -dopt=on -G")
