...
template <>
struct BasisLagrange<mesh::RefElTetra, 2> {
  using ref_el_t = mesh::RefElTetra;
  ...
  static constexpr Scalar eval_basis(dim_ti, const Scalar *x) {
    switch (i) {
    case 0:
      return (x[0] + x[1] + x[2] - 1) * (2 * x[0] + 2 * x[1] + 2 * x[2] - 1);
    case 1:
      return x[0] * (2 * x[0] - 1);
    case 2:
      return x[1] * (2 * x[1] - 1);
    case 3:
      return x[2] * (2 * x[2] - 1);
    case 4:
      return -4 * x[0] * (x[0] + x[1] + x[2] - 1);
    case 5:
      return -4 * x[1] * (x[0] + x[1] + x[2] - 1);
    case 6:
      return -4 * x[2] * (x[0] + x[1] + x[2] - 1);
    case 7:
      return 4 * x[0] * x[1];
    case 8:
      return 4 * x[1] * x[2];
  ...
  static constexpr void grad_basis(dim_t i, const Scalar *x, Scalar *out) {
    switch (i) {
    case 0:
      const Scalar x0 = 4 * x[0] + 4 * x[1] + 4 * x[2] - 3;
      out[0] = x0;
      out[1] = x0;
      out[2] = x0;
      break;
...
template <>
struct BasisLagrange<mesh::RefElTetra, 3> {
  using ref_el_t = mesh::RefElTetra;
  ...
  static constexpr Scalar eval_basis(dim_ti, const Scalar *x) {
    switch (i) {
    case 0:
      const Scalar x0 = 3 * x[0] + 3 * x[1] + 3 * x[2];
      return -1.0 / 2.0 * (x0 - 2) * (x0 - 1) * (x[0] + x[1] + x[2] - 1);
    case 1:
      const Scalar x0 = 3 * x[0];
      return (1.0 / 2.0) * x[0] * (x0 - 2) * (x0 - 1);
    case 2:
      const Scalar x0 = 3 * x[1];
      return (1.0 / 2.0) * x[1] * (x0 - 2) * (x0 - 1);
    case 3:
      const Scalar x0 = 3 * x[2];
      return (1.0 / 2.0) * x[2] * (x0 - 2) * (x0 - 1);
    case 4:
      return (9.0 / 2.0) * x[0] * (x[0] + x[1] + x[2] - 1) *
             (3 * x[0] + 3 * x[1] + 3 * x[2] - 2);
    case 5:
      return -9.0 / 2.0 * x[0] * (3 * x[0] - 1) * (x[0] + x[1] + x[2] - 1);
    case 6:
      return (9.0 / 2.0) * x[1] * (x[0] + x[1] + x[2] - 1) *
             (3 * x[0] + 3 * x[1] + 3 * x[2] - 2);
    case 7:
      return -9.0 / 2.0 * x[1] * (3 * x[1] - 1) * (x[0] + x[1] + x[2] - 1);
    case 8:
      return (9.0 / 2.0) * x[2] * (x[0] + x[1] + x[2] - 1) *
             (3 * x[0] + 3 * x[1] + 3 * x[2] - 2);
    case 9:
      return -9.0 / 2.0 * x[2] * (3 * x[2] - 1) * (x[0] + x[1] + x[2] - 1);
    case 10:
      return (9.0 / 2.0) * x[0] * x[1] * (3 * x[0] - 1);
    case 11:
      return (9.0 / 2.0) * x[0] * x[1] * (3 * x[1] - 1);
    case 12:
      return (9.0 / 2.0) * x[1] * x[2] * (3 * x[1] - 1);
    case 13:
      return (9.0 / 2.0) * x[1] * x[2] * (3 * x[2] - 1);
    case 14:
      return (9.0 / 2.0) * x[0] * x[2] * (3 * x[2] - 1);
    case 15:
      return (9.0 / 2.0) * x[0] * x[2] * (3 * x[0] - 1);
    case 16:
      return -27 * x[0] * x[1] * (x[0] + x[1] + x[2] - 1);
    case 17:
      return -27 * x[1] * x[2] * (x[0] + x[1] + x[2] - 1);
    case 18:
      return -27 * x[0] * x[2] * (x[0] + x[1] + x[2] - 1);
    case 19:
      return 27 * x[0] * x[1] * x[2];
    default:
      return 0;
    }
  }
  ...
  static constexpr void grad_basis(dim_t i, const Scalar *x, Scalar *out) {
    ...
    case 0:
      ...
      const Scalar x2 = 3 * x[0] + 3 * x[1] + 3 * x[2] - 3;
      const Scalar x3 = x0 - 1;
      const Scalar x4 =
          -1.0 / 2.0 * x1 * x2 - 1.0 / 2.0 * x1 * x3 - 1.0 / 2.0 * x2 * x3;
      out[0] = x4;
      out[1] = x4;
      out[2] = x4;
      break;
    case 1:
      ...
      const Scalar x1 = x0 - 2;
      const Scalar x2 = x0 - 1;
      out[0] = (1.0 / 2.0) * x1 * x2 + (3.0 / 2.0) * x1 * x[0] +
               (3.0 / 2.0) * x2 * x[0];
      out[1] = 0;
      out[2] = 0;
      break;
    case 2:
      ...
      const Scalar x2 = x0 - 1;
      out[0] = 0;
      out[1] = (1.0 / 2.0) * x1 * x2 + (3.0 / 2.0) * x1 * x[1] +
               (3.0 / 2.0) * x2 * x[1];
      out[2] = 0;
      break;
    case 3:
      ...
      out[0] = 0;
      out[1] = 0;
      out[2] = (1.0 / 2.0) * x1 * x2 + (3.0 / 2.0) * x1 * x[2] +
               (3.0 / 2.0) * x2 * x[2];
      break;
    case 4:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 3 * x[0];
      const Scalar x2 = x1 + 3 * x[1] + 3 * x[2];
      const Scalar x3 = x2 - 2;
      const Scalar x4 = 9 * x[0] * (x2 - 5.0 / 2.0);
      out[0] = (9.0 / 2.0) * x0 * x1 + (9.0 / 2.0) * x0 * x3 +
               (9.0 / 2.0) * x3 * x[0];
      out[1] = x4;
      out[2] = x4;
      break;
    case 5:
      ...
      const Scalar x3 = x[0] + x[1] + x[2] - 1;
      const Scalar x4 = -9.0 / 2.0 * x2;
      out[0] = -9.0 / 2.0 * x0 * x3 - 9.0 / 2.0 * x1 * x3 - 9.0 / 2.0 * x2;
      out[1] = x4;
      out[2] = x4;
      break;
    case 6:
      const Scalar x0 = 3 * x[1];
      const Scalar x1 = x0 + 3 * x[0] + 3 * x[2];
      const Scalar x2 = 9 * x[1] * (x1 - 5.0 / 2.0);
      const Scalar x3 = x[0] + x[1] + x[2] - 1;
      const Scalar x4 = x1 - 2;
      out[0] = x2;
      out[1] = (9.0 / 2.0) * x0 * x3 + (9.0 / 2.0) * x3 * x4 +
               (9.0 / 2.0) * x4 * x[1];
      out[2] = x2;
      break;
    case 7:
      const Scalar x0 = 3 * x[1];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x1 * x[1];
      const Scalar x3 = -9.0 / 2.0 * x2;
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      out[0] = x3;
      out[1] = -9.0 / 2.0 * x0 * x4 - 9.0 / 2.0 * x1 * x4 - 9.0 / 2.0 * x2;
      out[2] = x3;
      break;
    case 8:
      const Scalar x0 = 3 * x[2];
      const Scalar x1 = x0 + 3 * x[0] + 3 * x[1];
      const Scalar x2 = 9 * x[2] * (x1 - 5.0 / 2.0);
      const Scalar x3 = x[0] + x[1] + x[2] - 1;
      const Scalar x4 = x1 - 2;
      out[0] = x2;
      out[1] = x2;
      out[2] = (9.0 / 2.0) * x0 * x3 + (9.0 / 2.0) * x3 * x4 +
               (9.0 / 2.0) * x4 * x[2];
      break;
    case 9:
      const Scalar x0 = 3 * x[2];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x1 * x[2];
      const Scalar x3 = -9.0 / 2.0 * x2;
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      out[0] = x3;
      out[1] = x3;
      out[2] = -9.0 / 2.0 * x0 * x4 - 9.0 / 2.0 * x1 * x4 - 9.0 / 2.0 * x2;
      break;
    case 10:
      out[0] = (9.0 / 2.0) * x[1] * (6 * x[0] - 1);
      out[1] = (9.0 / 2.0) * x[0] * (3 * x[0] - 1);
      out[2] = 0;
      break;
    case 11:
      out[0] = (9.0 / 2.0) * x[1] * (3 * x[1] - 1);
      out[1] = (9.0 / 2.0) * x[0] * (6 * x[1] - 1);
      out[2] = 0;
      break;
    case 12:
      out[0] = 0;
      out[1] = (9.0 / 2.0) * x[2] * (6 * x[1] - 1);
      out[2] = (9.0 / 2.0) * x[1] * (3 * x[1] - 1);
      break;
    case 13:
      out[0] = 0;
      out[1] = (9.0 / 2.0) * x[2] * (3 * x[2] - 1);
      out[2] = (9.0 / 2.0) * x[1] * (6 * x[2] - 1);
      break;
    case 14:
      out[0] = (9.0 / 2.0) * x[2] * (3 * x[2] - 1);
      out[1] = 0;
      out[2] = (9.0 / 2.0) * x[0] * (6 * x[2] - 1);
      break;
    case 15:
      out[0] = (9.0 / 2.0) * x[2] * (6 * x[0] - 1);
      out[1] = 0;
      out[2] = (9.0 / 2.0) * x[0] * (3 * x[0] - 1);
      break;
    case 16:
      const Scalar x0 = x[2] - 1;
      const Scalar x1 = 27 * x[1];
      out[0] = -x1 * (x0 + 2 * x[0] + x[1]);
      out[1] = -27 * x[0] * (x0 + x[0] + 2 * x[1]);
      out[2] = -x1 * x[0];
      break;
    case 17:
      const Scalar x0 = 27 * x[2];
      const Scalar x1 = x[0] - 1;
      out[0] = -x0 * x[1];
      out[1] = -x0 * (x1 + 2 * x[1] + x[2]);
      out[2] = -27 * x[1] * (x1 + x[1] + 2 * x[2]);
      break;
    case 18:
      const Scalar x0 = x[1] - 1;
      const Scalar x1 = 27 * x[2];
      out[0] = -x1 * (x0 + 2 * x[0] + x[2]);
      out[1] = -x1 * x[0];
      out[2] = -27 * x[0] * (x0 + x[0] + 2 * x[2]);
      break;
    case 19:
      const Scalar x0 = 27 * x[2];
      out[0] = x0 * x[1];
...
template <>
struct BasisLagrange<mesh::RefElTetra, 4> {
  using ref_el_t = mesh::RefElTetra;
  ...
  static constexpr Scalar eval_basis(dim_ti, const Scalar *x) {
    switch (i) {
    case 0:
      const Scalar x0 = 4 * x[0] + 4 * x[1] + 4 * x[2];
      return (1.0 / 3.0) * (x0 - 3) * (x0 - 1) * (x[0] + x[1] + x[2] - 1) *
             (2 * x[0] + 2 * x[1] + 2 * x[2] - 1);
    case 1:
      const Scalar x0 = 4 * x[0];
    ...
    case 2:
      const Scalar x0 = 4 * x[1];
      return (1.0 / 3.0) * x[1] * (x0 - 3) * (x0 - 1) * (2 * x[1] - 1);
    case 3:
      const Scalar x0 = 4 * x[2];
      return (1.0 / 3.0) * x[2] * (x0 - 3) * (x0 - 1) * (2 * x[2] - 1);
    case 4:
      return -16.0 / 3.0 * x[0] * (x[0] + x[1] + x[2] - 1) *
             (2 * x[0] + 2 * x[1] + 2 * x[2] - 1) *
             (4 * x[0] + 4 * x[1] + 4 * x[2] - 3);
    case 5:
      return -16.0 / 3.0 * x[0] * (2 * x[0] - 1) * (4 * x[0] - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 6:
      const Scalar x0 = 4 * x[0];
      return x0 * (x0 - 1) * (x0 + 4 * x[1] + 4 * x[2] - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 7:
      return -16.0 / 3.0 * x[1] * (x[0] + x[1] + x[2] - 1) *
             (2 * x[0] + 2 * x[1] + 2 * x[2] - 1) *
             (4 * x[0] + 4 * x[1] + 4 * x[2] - 3);
    case 8:
      return -16.0 / 3.0 * x[1] * (2 * x[1] - 1) * (4 * x[1] - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 9:
      const Scalar x0 = 4 * x[1];
      return x0 * (x0 - 1) * (x0 + 4 * x[0] + 4 * x[2] - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 10:
      return -16.0 / 3.0 * x[2] * (x[0] + x[1] + x[2] - 1) *
             (2 * x[0] + 2 * x[1] + 2 * x[2] - 1) *
             (4 * x[0] + 4 * x[1] + 4 * x[2] - 3);
    case 11:
      return -16.0 / 3.0 * x[2] * (2 * x[2] - 1) * (4 * x[2] - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 12:
      const Scalar x0 = 4 * x[2];
      return x0 * (x0 - 1) * (x0 + 4 * x[0] + 4 * x[1] - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 13:
      return (16.0 / 3.0) * x[0] * x[1] * (2 * x[0] - 1) * (4 * x[0] - 1);
    case 14:
      return (16.0 / 3.0) * x[0] * x[1] * (2 * x[1] - 1) * (4 * x[1] - 1);
    case 15:
      const Scalar x0 = 4 * x[0];
      return x0 * x[1] * (x0 - 1) * (4 * x[1] - 1);
    case 16:
      return (16.0 / 3.0) * x[1] * x[2] * (2 * x[1] - 1) * (4 * x[1] - 1);
    case 17:
      return (16.0 / 3.0) * x[1] * x[2] * (2 * x[2] - 1) * (4 * x[2] - 1);
    case 18:
      const Scalar x0 = 4 * x[1];
      return x0 * x[2] * (x0 - 1) * (4 * x[2] - 1);
    case 19:
      return (16.0 / 3.0) * x[0] * x[2] * (2 * x[2] - 1) * (4 * x[2] - 1);
    case 20:
      return (16.0 / 3.0) * x[0] * x[2] * (2 * x[0] - 1) * (4 * x[0] - 1);
    case 21:
      const Scalar x0 = 4 * x[0];
      return x0 * x[2] * (x0 - 1) * (4 * x[2] - 1);
    case 22:
      return 32 * x[0] * x[1] * (x[0] + x[1] + x[2] - 1) *
             (4 * x[0] + 4 * x[1] + 4 * x[2] - 3);
    case 23:
      return -32 * x[0] * x[1] * (4 * x[1] - 1) * (x[0] + x[1] + x[2] - 1);
    case 24:
      return -32 * x[0] * x[1] * (4 * x[0] - 1) * (x[0] + x[1] + x[2] - 1);
    case 25:
      return 32 * x[1] * x[2] * (x[0] + x[1] + x[2] - 1) *
             (4 * x[0] + 4 * x[1] + 4 * x[2] - 3);
    case 26:
      return -32 * x[1] * x[2] * (4 * x[2] - 1) * (x[0] + x[1] + x[2] - 1);
    case 27:
      return -32 * x[1] * x[2] * (4 * x[1] - 1) * (x[0] + x[1] + x[2] - 1);
    case 28:
      return 32 * x[0] * x[2] * (x[0] + x[1] + x[2] - 1) *
             (4 * x[0] + 4 * x[1] + 4 * x[2] - 3);
    case 29:
      return -32 * x[0] * x[2] * (4 * x[0] - 1) * (x[0] + x[1] + x[2] - 1);
    case 30:
      return -32 * x[0] * x[2] * (4 * x[2] - 1) * (x[0] + x[1] + x[2] - 1);
    case 31:
      return 32 * x[0] * x[1] * x[2] * (4 * x[0] - 1);
    case 32:
      return 32 * x[0] * x[1] * x[2] * (4 * x[1] - 1);
    case 33:
      return 32 * x[0] * x[1] * x[2] * (4 * x[2] - 1);
    case 34:
      return -256 * x[0] * x[1] * x[2] * (x[0] + x[1] + x[2] - 1);
    default:
      return 0;
    }
  }
  ...
  static constexpr void grad_basis(dim_t i, const Scalar *x, Scalar *out) {
    ...
    case 0:
      ...
      const Scalar x2 = 2 * x[0] + 2 * x[1] + 2 * x[2] - 1;
      const Scalar x3 = x[0] + x[1] + x[2] - 1;
      const Scalar x4 = 4 * x2 * x3;
      const Scalar x5 = x0 - 1;
      const Scalar x6 = x1 * x5;
      const Scalar x7 = (1.0 / 3.0) * x1 * x4 + (1.0 / 3.0) * x2 * x6 +
    ...
    case 2:
      ...
      const Scalar x6 = x1 * x5;
      out[0] = 0;
      out[1] = (1.0 / 3.0) * x1 * x4 + (1.0 / 3.0) * x2 * x6 +
               (1.0 / 3.0) * x3 * x6 + (1.0 / 3.0) * x4 * x5;
      out[2] = 0;
      break;
    case 3:
      ...
      out[0] = 0;
      out[1] = 0;
      out[2] = (1.0 / 3.0) * x1 * x4 + (1.0 / 3.0) * x2 * x6 +
               (1.0 / 3.0) * x3 * x6 + (1.0 / 3.0) * x4 * x5;
      break;
    case 4:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 4 * x[0] + 4 * x[1] + 4 * x[2] - 3;
      const Scalar x2 = x0 * x1;
      const Scalar x3 = 2 * x[0];
      const Scalar x4 = x3 + 2 * x[1] + 2 * x[2] - 1;
      const Scalar x5 = x0 * x4;
      const Scalar x6 = (1.0 / 2.0) * x4;
      const Scalar x7 = x1 * x6;
      const Scalar x8 = -32.0 / 3.0 * x[0] * (x2 + 2 * x5 + x7);
      out[0] = -32.0 / 3.0 * x2 * x6 - 32.0 / 3.0 * x2 * x[0] -
               32.0 / 3.0 * x3 * x5 - 32.0 / 3.0 * x7 * x[0];
      out[1] = x8;
      out[2] = x8;
      break;
    case 5:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 4 * x[0] - 1;
      const Scalar x2 = x1 * x[0];
      const Scalar x3 = 2 * x[0];
      const Scalar x4 = x3 - 1;
      const Scalar x5 = (1.0 / 2.0) * x4;
      const Scalar x6 = -32.0 / 3.0 * x4 * x[0] * (x3 - 1.0 / 2.0);
      out[0] = -32.0 / 3.0 * x0 * x1 * x5 - 32.0 / 3.0 * x0 * x2 -
               32.0 / 3.0 * x0 * x3 * x4 - 32.0 / 3.0 * x2 * x5;
      out[1] = x6;
      out[2] = x6;
      break;
    case 6:
      const Scalar x0 = 4 * x[0];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x[0] + x[1] + x[2] - 1;
      const Scalar x3 = x2 * x[0];
      const Scalar x4 = x0 + 4 * x[1] + 4 * x[2] - 3;
      const Scalar x5 = x1 * x[0];
      const Scalar x6 = (1.0 / 4.0) * x4;
      const Scalar x7 = 16 * x5 * (2 * x[0] + 2 * x[1] + 2 * x[2] - 7.0 / 4.0);
      out[0] = 16 * x1 * x2 * x6 + 16 * x1 * x3 + 16 * x3 * x4 + 16 * x5 * x6;
      out[1] = x7;
      out[2] = x7;
      break;
    case 7:
      ...
      const Scalar x4 = x3 + 2 * x[0] + 2 * x[2] - 1;
      const Scalar x5 = x0 * x4;
      const Scalar x6 = (1.0 / 2.0) * x4;
      const Scalar x7 = x1 * x6;
      const Scalar x8 = -32.0 / 3.0 * x[1] * (x2 + 2 * x5 + x7);
      out[0] = x8;
      out[1] = -32.0 / 3.0 * x2 * x6 - 32.0 / 3.0 * x2 * x[1] -
               32.0 / 3.0 * x3 * x5 - 32.0 / 3.0 * x7 * x[1];
      out[2] = x8;
      break;
    case 8:
      const Scalar x0 = 2 * x[1];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = -32.0 / 3.0 * x1 * x[1] * (x0 - 1.0 / 2.0);
      const Scalar x3 = x[0] + x[1] + x[2] - 1;
      const Scalar x4 = 4 * x[1] - 1;
      const Scalar x5 = x4 * x[1];
      const Scalar x6 = (1.0 / 2.0) * x1;
      out[0] = x2;
      out[1] = -32.0 / 3.0 * x0 * x1 * x3 - 32.0 / 3.0 * x3 * x4 * x6 -
               32.0 / 3.0 * x3 * x5 - 32.0 / 3.0 * x5 * x6;
      out[2] = x2;
      break;
    case 9:
      const Scalar x0 = 4 * x[1];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x1 * x[1];
      const Scalar x3 = 16 * x2 * (2 * x[0] + 2 * x[1] + 2 * x[2] - 7.0 / 4.0);
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      const Scalar x5 = x4 * x[1];
      const Scalar x6 = x0 + 4 * x[0] + 4 * x[2] - 3;
      const Scalar x7 = (1.0 / 4.0) * x6;
      out[0] = x3;
      out[1] = 16 * x1 * x4 * x7 + 16 * x1 * x5 + 16 * x2 * x7 + 16 * x5 * x6;
      out[2] = x3;
      break;
    case 10:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      ...
      const Scalar x2 = x0 * x1;
      const Scalar x3 = 2 * x[2];
      const Scalar x4 = x3 + 2 * x[0] + 2 * x[1] - 1;
      const Scalar x5 = x0 * x4;
      const Scalar x6 = (1.0 / 2.0) * x4;
      const Scalar x7 = x1 * x6;
      const Scalar x8 = -32.0 / 3.0 * x[2] * (x2 + 2 * x5 + x7);
      out[0] = x8;
      out[1] = x8;
      out[2] = -32.0 / 3.0 * x2 * x6 - 32.0 / 3.0 * x2 * x[2] -
               32.0 / 3.0 * x3 * x5 - 32.0 / 3.0 * x7 * x[2];
      break;
    case 11:
      const Scalar x0 = 2 * x[2];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = -32.0 / 3.0 * x1 * x[2] * (x0 - 1.0 / 2.0);
      const Scalar x3 = x[0] + x[1] + x[2] - 1;
      const Scalar x4 = 4 * x[2] - 1;
      const Scalar x5 = x4 * x[2];
      const Scalar x6 = (1.0 / 2.0) * x1;
      out[0] = x2;
      out[1] = x2;
      out[2] = -32.0 / 3.0 * x0 * x1 * x3 - 32.0 / 3.0 * x3 * x4 * x6 -
               32.0 / 3.0 * x3 * x5 - 32.0 / 3.0 * x5 * x6;
      break;
    case 12:
      const Scalar x0 = 4 * x[2];
      ...
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      const Scalar x5 = x4 * x[2];
      const Scalar x6 = x0 + 4 * x[0] + 4 * x[1] - 3;
      const Scalar x7 = (1.0 / 4.0) * x6;
      out[0] = x3;
      out[1] = x3;
      out[2] = 16 * x1 * x4 * x7 + 16 * x1 * x5 + 16 * x2 * x7 + 16 * x5 * x6;
      break;
    case 13:
      const Scalar x0 = 4 * x[0] - 1;
      const Scalar x1 = 2 * x[0];
      const Scalar x2 = x1 - 1;
      out[0] =
          (32.0 / 3.0) * x[1] * ((1.0 / 2.0) * x0 * x2 + x0 * x[0] + x1 * x2);
      out[1] = (32.0 / 3.0) * x2 * x[0] * (x1 - 1.0 / 2.0);
      out[2] = 0;
      break;
    case 14:
      const Scalar x0 = 2 * x[1];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = 4 * x[1] - 1;
      out[0] = (32.0 / 3.0) * x1 * x[1] * (x0 - 1.0 / 2.0);
      out[1] =
          (32.0 / 3.0) * x[0] * (x0 * x1 + (1.0 / 2.0) * x1 * x2 + x2 * x[1]);
      out[2] = 0;
      break;
    case 15:
      out[0] = 16 * x[1] * (2 * x[0] - 1.0 / 4.0) * (4 * x[1] - 1);
      out[1] = 16 * x[0] * (4 * x[0] - 1) * (2 * x[1] - 1.0 / 4.0);
      out[2] = 0;
      break;
    case 16:
      const Scalar x0 = 4 * x[1] - 1;
      const Scalar x1 = 2 * x[1];
      const Scalar x2 = x1 - 1;
      out[0] = 0;
      out[1] =
          (32.0 / 3.0) * x[2] * ((1.0 / 2.0) * x0 * x2 + x0 * x[1] + x1 * x2);
      out[2] = (32.0 / 3.0) * x2 * x[1] * (x1 - 1.0 / 2.0);
      break;
    case 17:
      const Scalar x0 = 2 * x[2];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = 4 * x[2] - 1;
      out[0] = 0;
      out[1] = (32.0 / 3.0) * x1 * x[2] * (x0 - 1.0 / 2.0);
      out[2] =
          (32.0 / 3.0) * x[1] * (x0 * x1 + (1.0 / 2.0) * x1 * x2 + x2 * x[2]);
      break;
    case 18:
      out[0] = 0;
      out[1] = 16 * x[2] * (2 * x[1] - 1.0 / 4.0) * (4 * x[2] - 1);
      out[2] = 16 * x[1] * (4 * x[1] - 1) * (2 * x[2] - 1.0 / 4.0);
      break;
    case 19:
      const Scalar x0 = 2 * x[2];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = 4 * x[2] - 1;
      out[0] = (32.0 / 3.0) * x1 * x[2] * (x0 - 1.0 / 2.0);
      out[1] = 0;
      out[2] =
          (32.0 / 3.0) * x[0] * (x0 * x1 + (1.0 / 2.0) * x1 * x2 + x2 * x[2]);
      break;
    case 20:
      const Scalar x0 = 4 * x[0] - 1;
      const Scalar x1 = 2 * x[0];
      const Scalar x2 = x1 - 1;
      out[0] =
          (32.0 / 3.0) * x[2] * ((1.0 / 2.0) * x0 * x2 + x0 * x[0] + x1 * x2);
      out[1] = 0;
      out[2] = (32.0 / 3.0) * x2 * x[0] * (x1 - 1.0 / 2.0);
      break;
    case 21:
      out[0] = 16 * x[2] * (2 * x[0] - 1.0 / 4.0) * (4 * x[2] - 1);
      out[1] = 0;
      out[2] = 16 * x[0] * (4 * x[0] - 1) * (2 * x[2] - 1.0 / 4.0);
      break;
    case 22:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 2 * x0;
      const Scalar x2 = 4 * x[0] + 4 * x[1] + 4 * x[2];
      const Scalar x3 = (1.0 / 2.0) * x2 - 3.0 / 2.0;
      const Scalar x4 = x0 * x3;
      const Scalar x5 = 64 * x[1];
      out[0] = x5 * (x1 * x[0] + x3 * x[0] + x4);
      out[1] = 64 * x[0] * (x1 * x[1] + x3 * x[1] + x4);
      out[2] = x5 * x[0] * (x2 - 7.0 / 2.0);
      break;
    case 23:
      const Scalar x0 = 4 * x[1] - 1;
      const Scalar x1 = (1.0 / 2.0) * x[1];
      const Scalar x2 = x[0] + x[1] + x[2] - 1;
      const Scalar x3 = 2 * x[1];
      const Scalar x4 = 64 * x[0];
      out[0] = -64 * x0 * x[1] * (x1 + x[0] + (1.0 / 2.0) * x[2] - 1.0 / 2.0);
      out[1] = -x4 * (x0 * x1 + (1.0 / 2.0) * x0 * x2 + x2 * x3);
      out[2] = -x4 * x[1] * (x3 - 1.0 / 2.0);
      break;
    case 24:
      const Scalar x0 = 4 * x[0] - 1;
      const Scalar x1 = (1.0 / 2.0) * x[0];
      const Scalar x2 = x[0] + x[1] + x[2] - 1;
      const Scalar x3 = 2 * x[0];
      const Scalar x4 = 64 * x[1];
      out[0] = -x4 * (x0 * x1 + (1.0 / 2.0) * x0 * x2 + x2 * x3);
      out[1] = -64 * x0 * x[0] * (x1 + x[1] + (1.0 / 2.0) * x[2] - 1.0 / 2.0);
      out[2] = -x4 * x[0] * (x3 - 1.0 / 2.0);
      break;
    case 25:
      const Scalar x0 = 4 * x[0] + 4 * x[1] + 4 * x[2];
      const Scalar x1 = 64 * x[2];
      const Scalar x2 = x[0] + x[1] + x[2] - 1;
      const Scalar x3 = 2 * x2;
      const Scalar x4 = (1.0 / 2.0) * x0 - 3.0 / 2.0;
      const Scalar x5 = x2 * x4;
      out[0] = x1 * x[1] * (x0 - 7.0 / 2.0);
      out[1] = x1 * (x3 * x[1] + x4 * x[1] + x5);
      out[2] = 64 * x[1] * (x3 * x[2] + x4 * x[2] + x5);
      break;
    case 26:
      const Scalar x0 = 2 * x[2];
      const Scalar x1 = 64 * x[1];
      const Scalar x2 = 4 * x[2] - 1;
      const Scalar x3 = (1.0 / 2.0) * x[2];
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      out[0] = -x1 * x[2] * (x0 - 1.0 / 2.0);
      out[1] = -64 * x2 * x[2] * (x3 + (1.0 / 2.0) * x[0] + x[1] - 1.0 / 2.0);
      out[2] = -x1 * (x0 * x4 + x2 * x3 + (1.0 / 2.0) * x2 * x4);
      break;
    case 27:
      const Scalar x0 = 2 * x[1];
      const Scalar x1 = 64 * x[2];
      const Scalar x2 = 4 * x[1] - 1;
      const Scalar x3 = (1.0 / 2.0) * x[1];
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      out[0] = -x1 * x[1] * (x0 - 1.0 / 2.0);
      out[1] = -x1 * (x0 * x4 + x2 * x3 + (1.0 / 2.0) * x2 * x4);
      out[2] = -64 * x2 * x[1] * (x3 + (1.0 / 2.0) * x[0] + x[2] - 1.0 / 2.0);
      break;
    case 28:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 2 * x0;
      ...
      const Scalar x3 = (1.0 / 2.0) * x2 - 3.0 / 2.0;
      const Scalar x4 = x0 * x3;
      const Scalar x5 = 64 * x[2];
      out[0] = x5 * (x1 * x[0] + x3 * x[0] + x4);
      out[1] = x5 * x[0] * (x2 - 7.0 / 2.0);
      out[2] = 64 * x[0] * (x1 * x[2] + x3 * x[2] + x4);
      break;
    case 29:
      const Scalar x0 = 4 * x[0] - 1;
      const Scalar x1 = (1.0 / 2.0) * x[0];
      const Scalar x2 = x[0] + x[1] + x[2] - 1;
      const Scalar x3 = 2 * x[0];
      const Scalar x4 = 64 * x[2];
      out[0] = -x4 * (x0 * x1 + (1.0 / 2.0) * x0 * x2 + x2 * x3);
      out[1] = -x4 * x[0] * (x3 - 1.0 / 2.0);
      out[2] = -64 * x0 * x[0] * (x1 + (1.0 / 2.0) * x[1] + x[2] - 1.0 / 2.0);
      break;
    case 30:
      const Scalar x0 = 4 * x[2] - 1;
      const Scalar x1 = (1.0 / 2.0) * x[2];
      const Scalar x2 = 2 * x[2];
      const Scalar x3 = 64 * x[0];
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      out[0] = -64 * x0 * x[2] * (x1 + x[0] + (1.0 / 2.0) * x[1] - 1.0 / 2.0);
      out[1] = -x3 * x[2] * (x2 - 1.0 / 2.0);
      out[2] = -x3 * (x0 * x1 + (1.0 / 2.0) * x0 * x4 + x2 * x4);
      break;
    case 31:
      const Scalar x0 = 64 * x[2];
      const Scalar x1 = x[0] * (2 * x[0] - 1.0 / 2.0);
      out[0] = x0 * x[1] * (4 * x[0] - 1.0 / 2.0);
      out[1] = x0 * x1;
      out[2] = 64 * x1 * x[1];
      break;
    case 32:
      const Scalar x0 = 64 * x[2];
      const Scalar x1 = x[1] * (2 * x[1] - 1.0 / 2.0);
      out[0] = x0 * x1;
      out[1] = x0 * x[0] * (4 * x[1] - 1.0 / 2.0);
      out[2] = 64 * x1 * x[0];
      break;
    case 33:
      const Scalar x0 = 64 * x[1];
      const Scalar x1 = x[2] * (2 * x[2] - 1.0 / 2.0);
      out[0] = x0 * x1;
      out[1] = 64 * x1 * x[0];
      out[2] = x0 * x[0] * (4 * x[2] - 1.0 / 2.0);
      break;
    case 34:
      const Scalar x0 = x[2] - 1;
      const Scalar x1 = 256 * x[2];
      out[0] = -x1 * x[1] * (x0 + 2 * x[0] + x[1]);
      out[1] = -x1 * x[0] * (x0 + x[0] + 2 * x[1]);
      out[2] = -256 * x[0] * x[1] * (x[0] + x[1] + 2 * x[2] - 1);
      break;
    default:
      break;
    }
...
template <>
struct BasisLagrange<mesh::RefElTetra, 5> {
  using ref_el_t = mesh::RefElTetra;
  ...
  static constexpr Scalar eval_basis(dim_ti, const Scalar *x) {
    switch (i) {
    case 0:
      const Scalar x0 = 5 * x[0] + 5 * x[1] + 5 * x[2];
    ...
    case 2:
      ...
      return (1.0 / 24.0) * x[1] * (x0 - 4) * (x0 - 3) * (x0 - 2) * (x0 - 1);
    case 3:
      const Scalar x0 = 5 * x[2];
      return (1.0 / 24.0) * x[2] * (x0 - 4) * (x0 - 3) * (x0 - 2) * (x0 - 1);
    case 4:
      const Scalar x0 = 5 * x[0] + 5 * x[1] + 5 * x[2];
      return (25.0 / 24.0) * x[0] * (x0 - 4) * (x0 - 3) * (x0 - 2) *
             (x[0] + x[1] + x[2] - 1);
    case 5:
      const Scalar x0 = 5 * x[0];
      return -25.0 / 24.0 * x[0] * (x0 - 3) * (x0 - 2) * (x0 - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 6:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = x0 + 5 * x[1] + 5 * x[2];
      return -25.0 / 12.0 * x[0] * (x0 - 1) * (x1 - 4) * (x1 - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 7:
      const Scalar x0 = 5 * x[0];
      return (25.0 / 12.0) * x[0] * (x0 - 2) * (x0 - 1) *
             (x0 + 5 * x[1] + 5 * x[2] - 4) * (x[0] + x[1] + x[2] - 1);
    case 8:
      const Scalar x0 = 5 * x[0] + 5 * x[1] + 5 * x[2];
      return (25.0 / 24.0) * x[1] * (x0 - 4) * (x0 - 3) * (x0 - 2) *
             (x[0] + x[1] + x[2] - 1);
    case 9:
      const Scalar x0 = 5 * x[1];
      return -25.0 / 24.0 * x[1] * (x0 - 3) * (x0 - 2) * (x0 - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 10:
      const Scalar x0 = 5 * x[1];
      const Scalar x1 = x0 + 5 * x[0] + 5 * x[2];
      return -25.0 / 12.0 * x[1] * (x0 - 1) * (x1 - 4) * (x1 - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 11:
      const Scalar x0 = 5 * x[1];
      return (25.0 / 12.0) * x[1] * (x0 - 2) * (x0 - 1) *
             (x0 + 5 * x[0] + 5 * x[2] - 4) * (x[0] + x[1] + x[2] - 1);
    case 12:
      const Scalar x0 = 5 * x[0] + 5 * x[1] + 5 * x[2];
      return (25.0 / 24.0) * x[2] * (x0 - 4) * (x0 - 3) * (x0 - 2) *
             (x[0] + x[1] + x[2] - 1);
    case 13:
      const Scalar x0 = 5 * x[2];
      return -25.0 / 24.0 * x[2] * (x0 - 3) * (x0 - 2) * (x0 - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 14:
      const Scalar x0 = 5 * x[2];
      const Scalar x1 = x0 + 5 * x[0] + 5 * x[1];
      return -25.0 / 12.0 * x[2] * (x0 - 1) * (x1 - 4) * (x1 - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 15:
      const Scalar x0 = 5 * x[2];
      return (25.0 / 12.0) * x[2] * (x0 - 2) * (x0 - 1) *
             (x0 + 5 * x[0] + 5 * x[1] - 4) * (x[0] + x[1] + x[2] - 1);
    case 16:
      const Scalar x0 = 5 * x[0];
      return (25.0 / 24.0) * x[0] * x[1] * (x0 - 3) * (x0 - 2) * (x0 - 1);
    case 17:
      const Scalar x0 = 5 * x[1];
      return (25.0 / 24.0) * x[0] * x[1] * (x0 - 3) * (x0 - 2) * (x0 - 1);
    case 18:
      const Scalar x0 = 5 * x[0];
      return (25.0 / 12.0) * x[0] * x[1] * (x0 - 2) * (x0 - 1) * (5 * x[1] - 1);
    case 19:
      const Scalar x0 = 5 * x[1];
      return (25.0 / 12.0) * x[0] * x[1] * (x0 - 2) * (x0 - 1) * (5 * x[0] - 1);
    case 20:
      const Scalar x0 = 5 * x[1];
      return (25.0 / 24.0) * x[1] * x[2] * (x0 - 3) * (x0 - 2) * (x0 - 1);
    case 21:
      const Scalar x0 = 5 * x[2];
      return (25.0 / 24.0) * x[1] * x[2] * (x0 - 3) * (x0 - 2) * (x0 - 1);
    case 22:
      const Scalar x0 = 5 * x[1];
      return (25.0 / 12.0) * x[1] * x[2] * (x0 - 2) * (x0 - 1) * (5 * x[2] - 1);
    case 23:
      const Scalar x0 = 5 * x[2];
      return (25.0 / 12.0) * x[1] * x[2] * (x0 - 2) * (x0 - 1) * (5 * x[1] - 1);
    case 24:
      const Scalar x0 = 5 * x[2];
      return (25.0 / 24.0) * x[0] * x[2] * (x0 - 3) * (x0 - 2) * (x0 - 1);
    case 25:
      const Scalar x0 = 5 * x[0];
      return (25.0 / 24.0) * x[0] * x[2] * (x0 - 3) * (x0 - 2) * (x0 - 1);
    case 26:
      const Scalar x0 = 5 * x[2];
      return (25.0 / 12.0) * x[0] * x[2] * (x0 - 2) * (x0 - 1) * (5 * x[0] - 1);
    case 27:
      const Scalar x0 = 5 * x[0];
      return (25.0 / 12.0) * x[0] * x[2] * (x0 - 2) * (x0 - 1) * (5 * x[2] - 1);
    case 28:
      const Scalar x0 = 5 * x[0] + 5 * x[1] + 5 * x[2];
      return -125.0 / 6.0 * x[0] * x[1] * (x0 - 4) * (x0 - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 29:
      const Scalar x0 = 5 * x[1];
      return -125.0 / 6.0 * x[0] * x[1] * (x0 - 2) * (x0 - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 30:
      const Scalar x0 = 5 * x[0];
      return -125.0 / 6.0 * x[0] * x[1] * (x0 - 2) * (x0 - 1) *
    ...
    case 31:
      const Scalar x0 = 5 * x[1];
      return (125.0 / 4.0) * x[0] * x[1] * (x0 - 1) *
             (x0 + 5 * x[0] + 5 * x[2] - 4) * (x[0] + x[1] + x[2] - 1);
    case 32:
      return -125.0 / 4.0 * x[0] * x[1] * (5 * x[0] - 1) * (5 * x[1] - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 33:
      const Scalar x0 = 5 * x[0];
      return (125.0 / 4.0) * x[0] * x[1] * (x0 - 1) *
    ...
    case 34:
      const Scalar x0 = 5 * x[0] + 5 * x[1] + 5 * x[2];
      return -125.0 / 6.0 * x[1] * x[2] * (x0 - 4) * (x0 - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 35:
      const Scalar x0 = 5 * x[2];
      return -125.0 / 6.0 * x[1] * x[2] * (x0 - 2) * (x0 - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 36:
      const Scalar x0 = 5 * x[1];
      return -125.0 / 6.0 * x[1] * x[2] * (x0 - 2) * (x0 - 1) *
    ...
    case 37:
      const Scalar x0 = 5 * x[2];
      return (125.0 / 4.0) * x[1] * x[2] * (x0 - 1) *
             (x0 + 5 * x[0] + 5 * x[1] - 4) * (x[0] + x[1] + x[2] - 1);
    case 38:
      return -125.0 / 4.0 * x[1] * x[2] * (5 * x[1] - 1) * (5 * x[2] - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 39:
      const Scalar x0 = 5 * x[1];
      return (125.0 / 4.0) * x[1] * x[2] * (x0 - 1) *
    ...
    case 40:
      const Scalar x0 = 5 * x[0] + 5 * x[1] + 5 * x[2];
      return -125.0 / 6.0 * x[0] * x[2] * (x0 - 4) * (x0 - 3) *
             (x[0] + x[1] + x[2] - 1);
    case 41:
      const Scalar x0 = 5 * x[0];
      return -125.0 / 6.0 * x[0] * x[2] * (x0 - 2) * (x0 - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 42:
      const Scalar x0 = 5 * x[2];
      return -125.0 / 6.0 * x[0] * x[2] * (x0 - 2) * (x0 - 1) *
    ...
    case 43:
      const Scalar x0 = 5 * x[0];
      return (125.0 / 4.0) * x[0] * x[2] * (x0 - 1) *
             (x0 + 5 * x[1] + 5 * x[2] - 4) * (x[0] + x[1] + x[2] - 1);
    case 44:
      return -125.0 / 4.0 * x[0] * x[2] * (5 * x[0] - 1) * (5 * x[2] - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 45:
      const Scalar x0 = 5 * x[2];
      return (125.0 / 4.0) * x[0] * x[2] * (x0 - 1) *
    ...
    case 46:
      const Scalar x0 = 5 * x[0];
      return (125.0 / 6.0) * x[0] * x[1] * x[2] * (x0 - 2) * (x0 - 1);
    case 47:
      const Scalar x0 = 5 * x[1];
      return (125.0 / 6.0) * x[0] * x[1] * x[2] * (x0 - 2) * (x0 - 1);
    case 48:
      ...
      return (125.0 / 6.0) * x[0] * x[1] * x[2] * (x0 - 2) * (x0 - 1);
    case 49:
      return (125.0 / 4.0) * x[0] * x[1] * x[2] * (5 * x[0] - 1) *
             (5 * x[1] - 1);
    case 50:
      return (125.0 / 4.0) * x[0] * x[1] * x[2] * (5 * x[1] - 1) *
             (5 * x[2] - 1);
    case 51:
      return (125.0 / 4.0) * x[0] * x[1] * x[2] * (5 * x[0] - 1) *
             (5 * x[2] - 1);
    case 52:
      return (625.0 / 2.0) * x[0] * x[1] * x[2] * (x[0] + x[1] + x[2] - 1) *
             (5 * x[0] + 5 * x[1] + 5 * x[2] - 4);
    case 53:
      return -625.0 / 2.0 * x[0] * x[1] * x[2] * (5 * x[0] - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 54:
      return -625.0 / 2.0 * x[0] * x[1] * x[2] * (5 * x[1] - 1) *
             (x[0] + x[1] + x[2] - 1);
    case 55:
      return -625.0 / 2.0 * x[0] * x[1] * x[2] * (5 * x[2] - 1) *
             (x[0] + x[1] + x[2] - 1);
    default:
      return 0;
    }
  ...
  static constexpr void grad_basis(dim_t i, const Scalar *x, Scalar *out) {
    ...
    case 0:
      ...
      const Scalar x2 = x[0] + x[1] + x[2] - 1;
      const Scalar x3 = x0 - 3;
      const Scalar x4 = x0 - 2;
      const Scalar x5 = x2 * x3 * x4;
      const Scalar x6 = x0 - 1;
      const Scalar x7 = x1 * x2 * x6;
      const Scalar x8 = -1.0 / 24.0 * x1 * x3 * x4 * x6 - 5.0 / 24.0 * x1 * x5 -
                        5.0 / 24.0 * x3 * x7 - 5.0 / 24.0 * x4 * x7 -
                        5.0 / 24.0 * x5 * x6;
      out[0] = x8;
      out[1] = x8;
      out[2] = x8;
    ...
    case 1:
      ...
      const Scalar x4 = x2 * x3 * x[0];
      const Scalar x5 = x0 - 1;
      const Scalar x6 = x1 * x5 * x[0];
      out[0] = (1.0 / 24.0) * x1 * x2 * x3 * x5 + (5.0 / 24.0) * x1 * x4 +
               (5.0 / 24.0) * x2 * x6 + (5.0 / 24.0) * x3 * x6 +
               (5.0 / 24.0) * x4 * x5;
      out[1] = 0;
      out[2] = 0;
      break;
    case 2:
      ...
      const Scalar x2 = x0 - 3;
      const Scalar x3 = x0 - 2;
      const Scalar x4 = x2 * x3 * x[1];
      const Scalar x5 = x0 - 1;
      const Scalar x6 = x1 * x5 * x[1];
      out[0] = 0;
      out[1] = (1.0 / 24.0) * x1 * x2 * x3 * x5 + (5.0 / 24.0) * x1 * x4 +
               (5.0 / 24.0) * x2 * x6 + (5.0 / 24.0) * x3 * x6 +
               (5.0 / 24.0) * x4 * x5;
      out[2] = 0;
      break;
    case 3:
      ...
      const Scalar x2 = x0 - 3;
      const Scalar x3 = x0 - 2;
      const Scalar x4 = x2 * x3 * x[2];
      const Scalar x5 = x0 - 1;
      const Scalar x6 = x1 * x5 * x[2];
      out[0] = 0;
      out[1] = 0;
      out[2] = (1.0 / 24.0) * x1 * x2 * x3 * x5 + (5.0 / 24.0) * x1 * x4 +
               (5.0 / 24.0) * x2 * x6 + (5.0 / 24.0) * x3 * x6 +
               (5.0 / 24.0) * x4 * x5;
      break;
    case 4:
      ...
      const Scalar x10 = 5 * x5;
      const Scalar x11 = x10 * x7;
      const Scalar x12 =
          (25.0 / 24.0) * x[0] * (x10 * x4 + x11 * x2 + x11 * x3 + x9);
      out[0] = (25.0 / 24.0) * x2 * x8 + (25.0 / 24.0) * x3 * x8 +
               (25.0 / 24.0) * x4 * x6 + (25.0 / 24.0) * x5 * x9 +
               (25.0 / 24.0) * x9 * x[0];
      out[1] = x12;
      out[2] = x12;
      break;
    case 5:
      ...
      const Scalar x8 = x0 * x7;
      const Scalar x9 = x1 * x8;
      const Scalar x10 = -25.0 / 24.0 * x6;
      out[0] = -25.0 / 24.0 * x2 * x9 - 25.0 / 24.0 * x3 * x9 -
               25.0 / 24.0 * x4 * x8 - 25.0 / 24.0 * x5 * x7 - 25.0 / 24.0 * x6;
      out[1] = x10;
      out[2] = x10;
      break;
    case 6:
      ...
      const Scalar x7 = x1 - 3;
      const Scalar x8 = x2 * x7;
      const Scalar x9 = x3 * x8;
      const Scalar x10 = 5 * x4;
      const Scalar x11 = -25.0 / 12.0 * x3 * x[0] * (x10 * x2 + x10 * x7 + x8);
      out[0] = -25.0 / 12.0 * x2 * x6 - 25.0 / 12.0 * x4 * x9 -
               25.0 / 12.0 * x5 * x8 - 25.0 / 12.0 * x6 * x7 -
               25.0 / 12.0 * x9 * x[0];
      out[1] = x11;
      out[2] = x11;
      break;
    case 7:
      ...
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      const Scalar x5 = x0 * x4;
      const Scalar x6 = x0 + 5 * x[1] + 5 * x[2] - 4;
      const Scalar x7 = x3 * x6;
      const Scalar x8 = x5 * x6;
      const Scalar x9 =
          (25.0 / 12.0) * x3 * x[0] * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      out[0] = (25.0 / 12.0) * x1 * x8 + (25.0 / 12.0) * x2 * x8 +
               (25.0 / 12.0) * x3 * x5 + (25.0 / 12.0) * x4 * x7 +
               (25.0 / 12.0) * x7 * x[0];
      out[1] = x9;
      out[2] = x9;
      break;
    case 8:
      ...
      const Scalar x9 = x4 * x7;
      const Scalar x10 =
          (25.0 / 24.0) * x[1] * (x2 * x8 + x3 * x8 + x4 * x6 + x9);
      const Scalar x11 = x0 * x5;
      const Scalar x12 = x11 * x7;
      out[0] = x10;
      out[1] = (25.0 / 24.0) * x11 * x4 + (25.0 / 24.0) * x12 * x2 +
               (25.0 / 24.0) * x12 * x3 + (25.0 / 24.0) * x5 * x9 +
               (25.0 / 24.0) * x9 * x[1];
      out[2] = x10;
      break;
    case 9:
      ...
      const Scalar x7 = -25.0 / 24.0 * x6;
      const Scalar x8 = x[0] + x[1] + x[2] - 1;
      const Scalar x9 = x0 * x8;
      const Scalar x10 = x1 * x9;
      out[0] = x7;
      out[1] = -25.0 / 24.0 * x10 * x2 - 25.0 / 24.0 * x10 * x3 -
               25.0 / 24.0 * x4 * x9 - 25.0 / 24.0 * x5 * x8 - 25.0 / 24.0 * x6;
      out[2] = x7;
      break;
    case 10:
      const Scalar x0 = 5 * x[1];
      ...
      const Scalar x2 = x1 - 4;
      const Scalar x3 = x[0] + x[1] + x[2] - 1;
      const Scalar x4 = 5 * x3;
      const Scalar x5 = x1 - 3;
      const Scalar x6 = x2 * x5;
      const Scalar x7 = x0 - 1;
      const Scalar x8 = x7 * x[1];
      const Scalar x9 = -25.0 / 12.0 * x8 * (x2 * x4 + x4 * x5 + x6);
      const Scalar x10 = x3 * x7;
      const Scalar x11 = x0 * x10;
      out[0] = x9;
      out[1] = -25.0 / 12.0 * x0 * x3 * x6 - 25.0 / 12.0 * x10 * x6 -
               25.0 / 12.0 * x11 * x2 - 25.0 / 12.0 * x11 * x5 -
               25.0 / 12.0 * x6 * x8;
      out[2] = x9;
      break;
    case 11:
      ...
      const Scalar x3 = x1 * x2;
      const Scalar x4 =
          (25.0 / 12.0) * x3 * x[1] * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      const Scalar x5 = x[0] + x[1] + x[2] - 1;
      const Scalar x6 = x0 * x5;
      const Scalar x7 = x0 + 5 * x[0] + 5 * x[2] - 4;
      const Scalar x8 = x3 * x7;
      const Scalar x9 = x6 * x7;
      out[0] = x4;
      out[1] = (25.0 / 12.0) * x1 * x9 + (25.0 / 12.0) * x2 * x9 +
               (25.0 / 12.0) * x3 * x6 + (25.0 / 12.0) * x5 * x8 +
               (25.0 / 12.0) * x8 * x[1];
      out[2] = x4;
      break;
    case 12:
      ...
      const Scalar x9 = x4 * x7;
      const Scalar x10 =
          (25.0 / 24.0) * x[2] * (x2 * x8 + x3 * x8 + x4 * x6 + x9);
      const Scalar x11 = x0 * x5;
      const Scalar x12 = x11 * x7;
      out[0] = x10;
      out[1] = x10;
      out[2] = (25.0 / 24.0) * x11 * x4 + (25.0 / 24.0) * x12 * x2 +
               (25.0 / 24.0) * x12 * x3 + (25.0 / 24.0) * x5 * x9 +
               (25.0 / 24.0) * x9 * x[2];
      break;
    case 13:
      ...
      out[0] = x7;
      out[1] = x7;
      out[2] = -25.0 / 24.0 * x10 * x2 - 25.0 / 24.0 * x10 * x3 -
               25.0 / 24.0 * x4 * x9 - 25.0 / 24.0 * x5 * x8 - 25.0 / 24.0 * x6;
      break;
    case 14:
      const Scalar x0 = 5 * x[2];
      ...
      const Scalar x6 = x2 * x5;
      const Scalar x7 = x0 - 1;
      const Scalar x8 = x7 * x[2];
      const Scalar x9 = -25.0 / 12.0 * x8 * (x2 * x4 + x4 * x5 + x6);
      const Scalar x10 = x3 * x7;
      const Scalar x11 = x0 * x10;
      out[0] = x9;
      out[1] = x9;
      out[2] = -25.0 / 12.0 * x0 * x3 * x6 - 25.0 / 12.0 * x10 * x6 -
               25.0 / 12.0 * x11 * x2 - 25.0 / 12.0 * x11 * x5 -
               25.0 / 12.0 * x6 * x8;
      break;
    case 15:
      ...
      const Scalar x3 = x1 * x2;
      const Scalar x4 =
          (25.0 / 12.0) * x3 * x[2] * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      const Scalar x5 = x[0] + x[1] + x[2] - 1;
      const Scalar x6 = x0 * x5;
      const Scalar x7 = x0 + 5 * x[0] + 5 * x[1] - 4;
      const Scalar x8 = x3 * x7;
      const Scalar x9 = x6 * x7;
      out[0] = x4;
      out[1] = x4;
      out[2] = (25.0 / 12.0) * x1 * x9 + (25.0 / 12.0) * x2 * x9 +
               (25.0 / 12.0) * x3 * x6 + (25.0 / 12.0) * x5 * x8 +
               (25.0 / 12.0) * x8 * x[2];
      break;
    case 16:
      ...
      const Scalar x5 = x1 * x4;
      const Scalar x6 = x2 * x5;
      out[0] = (25.0 / 24.0) * x[1] * (x0 * x5 + x1 * x3 + x3 * x4 + x6);
      out[1] = (25.0 / 24.0) * x6 * x[0];
      out[2] = 0;
      break;
    case 17:
      const Scalar x0 = 5 * x[1];
      ...
      const Scalar x4 = x2 * x3;
      const Scalar x5 = x1 * x4;
      const Scalar x6 = x0 * x1;
      out[0] = (25.0 / 24.0) * x5 * x[1];
      out[1] = (25.0 / 24.0) * x[0] * (x0 * x4 + x2 * x6 + x3 * x6 + x5);
      out[2] = 0;
      break;
    case 18:
      const Scalar x0 = 5 * x[0];
      ...
      const Scalar x2 = x0 - 1;
      const Scalar x3 = x1 * x2;
      out[0] = (25.0 / 12.0) * x[1] * (5 * x[1] - 1) * (x0 * x1 + x0 * x2 + x3);
      out[1] = (25.0 / 12.0) * x3 * x[0] * (10 * x[1] - 1);
      out[2] = 0;
      break;
    case 19:
      const Scalar x0 = 5 * x[1];
      ...
      const Scalar x2 = x0 - 1;
      const Scalar x3 = x1 * x2;
      out[0] = (25.0 / 12.0) * x3 * x[1] * (10 * x[0] - 1);
      out[1] = (25.0 / 12.0) * x[0] * (5 * x[0] - 1) * (x0 * x1 + x0 * x2 + x3);
      out[2] = 0;
      break;
    case 20:
      const Scalar x0 = 5 * x[1];
      ...
      const Scalar x6 = x2 * x5;
      out[0] = 0;
      out[1] = (25.0 / 24.0) * x[2] * (x0 * x5 + x1 * x3 + x3 * x4 + x6);
      out[2] = (25.0 / 24.0) * x6 * x[1];
      break;
    case 21:
      const Scalar x0 = 5 * x[2];
      const Scalar x1 = x0 - 2;
      ...
      const Scalar x6 = x0 * x1;
      out[0] = 0;
      out[1] = (25.0 / 24.0) * x5 * x[2];
      out[2] = (25.0 / 24.0) * x[1] * (x0 * x4 + x2 * x6 + x3 * x6 + x5);
      break;
    case 22:
      const Scalar x0 = 5 * x[1];
      const Scalar x1 = x0 - 2;
      ...
      const Scalar x3 = x1 * x2;
      out[0] = 0;
      out[1] = (25.0 / 12.0) * x[2] * (5 * x[2] - 1) * (x0 * x1 + x0 * x2 + x3);
      out[2] = (25.0 / 12.0) * x3 * x[1] * (10 * x[2] - 1);
      break;
    case 23:
      const Scalar x0 = 5 * x[2];
      const Scalar x1 = x0 - 2;
      ...
      const Scalar x3 = x1 * x2;
      out[0] = 0;
      out[1] = (25.0 / 12.0) * x3 * x[2] * (10 * x[1] - 1);
      out[2] = (25.0 / 12.0) * x[1] * (5 * x[1] - 1) * (x0 * x1 + x0 * x2 + x3);
      break;
    case 24:
      const Scalar x0 = 5 * x[2];
      const Scalar x1 = x0 - 2;
      ...
      const Scalar x5 = x1 * x4;
      const Scalar x6 = x0 * x1;
      out[0] = (25.0 / 24.0) * x5 * x[2];
      out[1] = 0;
      out[2] = (25.0 / 24.0) * x[0] * (x0 * x4 + x2 * x6 + x3 * x6 + x5);
      break;
    case 25:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = x0 - 3;
      ...
      const Scalar x5 = x1 * x4;
      const Scalar x6 = x2 * x5;
      out[0] = (25.0 / 24.0) * x[2] * (x0 * x5 + x1 * x3 + x3 * x4 + x6);
      out[1] = 0;
      out[2] = (25.0 / 24.0) * x6 * x[0];
      break;
    case 26:
      const Scalar x0 = 5 * x[2];
      const Scalar x1 = x0 - 2;
      const Scalar x2 = x0 - 1;
      const Scalar x3 = x1 * x2;
      out[0] = (25.0 / 12.0) * x3 * x[2] * (10 * x[0] - 1);
      out[1] = 0;
      out[2] = (25.0 / 12.0) * x[0] * (5 * x[0] - 1) * (x0 * x1 + x0 * x2 + x3);
      break;
    case 27:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = x0 - 2;
      const Scalar x2 = x0 - 1;
      const Scalar x3 = x1 * x2;
      out[0] = (25.0 / 12.0) * x[2] * (5 * x[2] - 1) * (x0 * x1 + x0 * x2 + x3);
      out[1] = 0;
      out[2] = (25.0 / 12.0) * x3 * x[0] * (10 * x[2] - 1);
      break;
    case 28:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = 5 * x[1];
      const Scalar x2 = x0 + x1 + 5 * x[2];
      const Scalar x3 = x2 - 4;
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      const Scalar x5 = x0 * x4;
      const Scalar x6 = x2 - 3;
      const Scalar x7 = x3 * x6;
      const Scalar x8 = x4 * x7;
      const Scalar x9 = (125.0 / 6.0) * x[1];
      const Scalar x10 = x1 * x4;
      const Scalar x11 = 5 * x4;
      out[0] = -x9 * (x3 * x5 + x5 * x6 + x7 * x[0] + x8);
      out[1] = -125.0 / 6.0 * x[0] * (x10 * x3 + x10 * x6 + x7 * x[1] + x8);
      out[2] = -x9 * x[0] * (x11 * x3 + x11 * x6 + x7);
      break;
    case 29:
      ...
      const Scalar x4 = x2 * x3;
      const Scalar x5 = x4 * x[1];
      const Scalar x6 = x0 + x[0];
      const Scalar x7 = x1 * x6;
      const Scalar x8 = (125.0 / 6.0) * x[0];
      out[0] = -125.0 / 6.0 * x5 * (x0 + 2 * x[0]);
      out[1] = -x8 * (x2 * x7 + x3 * x7 + x4 * x6 + x5);
      out[2] = -x5 * x8;
      break;
    case 30:
      const Scalar x0 = 5 * x[0];
      ...
      const Scalar x5 = x[0] + x[2] - 1;
      const Scalar x6 = x5 + x[1];
      const Scalar x7 = x0 * x6;
      const Scalar x8 = (125.0 / 6.0) * x[1];
      out[0] = -x8 * (x1 * x7 + x2 * x7 + x3 * x6 + x4);
      out[1] = -125.0 / 6.0 * x4 * (x5 + 2 * x[1]);
      out[2] = -x4 * x8;
      break;
    case 31:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      ...
      const Scalar x3 = x1 + x2 + 5 * x[2] - 4;
      const Scalar x4 = x0 * x3;
      const Scalar x5 = x2 - 1;
      const Scalar x6 = x5 * x[1];
      const Scalar x7 = (125.0 / 4.0) * x[0];
      out[0] = (125.0 / 4.0) * x6 * (x0 * x1 + x3 * x[0] + x4);
      out[1] = x7 * (x0 * x2 * x5 + x2 * x4 + x3 * x6 + x4 * x5);
      out[2] = x6 * x7 * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      break;
    case 32:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x1 * x[0];
      const Scalar x3 = x[0] + x[1] + x[2] - 1;
      const Scalar x4 = 5 * x[1];
      const Scalar x5 = x4 - 1;
      const Scalar x6 = x5 * x[1];
      const Scalar x7 = (125.0 / 4.0) * x6;
      out[0] = -x7 * (x0 * x3 + x1 * x3 + x2);
      out[1] = -125.0 / 4.0 * x2 * (x3 * x4 + x3 * x5 + x6);
      out[2] = -x2 * x7;
      break;
    case 33:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 5 * x[0];
      const Scalar x2 = x1 - 1;
      const Scalar x3 = 5 * x[1];
      const Scalar x4 = x1 + x3 + 5 * x[2] - 4;
      const Scalar x5 = x2 * x[0];
      const Scalar x6 = x0 * x4;
      const Scalar x7 = (125.0 / 4.0) * x[1];
      out[0] = x7 * (x0 * x1 * x2 + x1 * x6 + x2 * x6 + x4 * x5);
      out[1] = (125.0 / 4.0) * x5 * (x0 * x3 + x4 * x[1] + x6);
      out[2] = x5 * x7 * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      break;
    case 34:
      const Scalar x0 = 5 * x[1];
      const Scalar x1 = 5 * x[2];
      const Scalar x2 = x0 + x1 + 5 * x[0];
      const Scalar x3 = x2 - 4;
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      const Scalar x5 = 5 * x4;
      const Scalar x6 = x2 - 3;
      const Scalar x7 = x3 * x6;
      const Scalar x8 = (125.0 / 6.0) * x[2];
      const Scalar x9 = x0 * x4;
      const Scalar x10 = x4 * x7;
      const Scalar x11 = x1 * x4;
      out[0] = -x8 * x[1] * (x3 * x5 + x5 * x6 + x7);
      out[1] = -x8 * (x10 + x3 * x9 + x6 * x9 + x7 * x[1]);
      out[2] = -125.0 / 6.0 * x[1] * (x10 + x11 * x3 + x11 * x6 + x7 * x[2]);
      break;
    case 35:
      const Scalar x0 = 5 * x[2];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x0 - 2;
      const Scalar x3 = x1 * x2;
      const Scalar x4 = x3 * x[2];
      const Scalar x5 = (125.0 / 6.0) * x[1];
      const Scalar x6 = x[0] + x[2] - 1;
      const Scalar x7 = x6 + x[1];
      const Scalar x8 = x0 * x7;
      out[0] = -x4 * x5;
      out[1] = -125.0 / 6.0 * x4 * (x6 + 2 * x[1]);
      out[2] = -x5 * (x1 * x8 + x2 * x8 + x3 * x7 + x4);
      break;
    case 36:
      const Scalar x0 = 5 * x[1];
      const Scalar x1 = x0 - 1;
      ...
      const Scalar x3 = x1 * x2;
      const Scalar x4 = x3 * x[1];
      const Scalar x5 = (125.0 / 6.0) * x[2];
      const Scalar x6 = x[0] + x[1] - 1;
      const Scalar x7 = x6 + x[2];
      const Scalar x8 = x0 * x7;
      out[0] = -x4 * x5;
      out[1] = -x5 * (x1 * x8 + x2 * x8 + x3 * x7 + x4);
      out[2] = -125.0 / 6.0 * x4 * (x6 + 2 * x[2]);
      break;
    case 37:
      const Scalar x0 = 5 * x[2];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x1 * x[2];
      const Scalar x3 = (125.0 / 4.0) * x[1];
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      const Scalar x5 = 5 * x[1];
      const Scalar x6 = x0 + x5 + 5 * x[0] - 4;
      const Scalar x7 = x4 * x6;
      out[0] = x2 * x3 * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      out[1] = (125.0 / 4.0) * x2 * (x4 * x5 + x6 * x[1] + x7);
      out[2] = x3 * (x0 * x1 * x4 + x0 * x7 + x1 * x7 + x2 * x6);
      break;
    case 38:
      const Scalar x0 = 5 * x[1];
      const Scalar x1 = x0 - 1;
      ...
      const Scalar x4 = x3 - 1;
      const Scalar x5 = x4 * x[2];
      const Scalar x6 = (125.0 / 4.0) * x5;
      const Scalar x7 = x[0] + x[1] + x[2] - 1;
      out[0] = -x2 * x6;
      out[1] = -x6 * (x0 * x7 + x1 * x7 + x2);
      out[2] = -125.0 / 4.0 * x2 * (x3 * x7 + x4 * x7 + x5);
      break;
    case 39:
      const Scalar x0 = 5 * x[1];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x1 * x[1];
      const Scalar x3 = (125.0 / 4.0) * x[2];
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      const Scalar x5 = 5 * x[2];
      const Scalar x6 = x0 + x5 + 5 * x[0] - 4;
      const Scalar x7 = x4 * x6;
      out[0] = x2 * x3 * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      out[1] = x3 * (x0 * x1 * x4 + x0 * x7 + x1 * x7 + x2 * x6);
      out[2] = (125.0 / 4.0) * x2 * (x4 * x5 + x6 * x[2] + x7);
      break;
    case 40:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = 5 * x[2];
      const Scalar x2 = x0 + x1 + 5 * x[1];
      const Scalar x3 = x2 - 4;
      const Scalar x4 = x[0] + x[1] + x[2] - 1;
      const Scalar x5 = x0 * x4;
      const Scalar x6 = x2 - 3;
      const Scalar x7 = x3 * x6;
      const Scalar x8 = x4 * x7;
      const Scalar x9 = (125.0 / 6.0) * x[2];
      const Scalar x10 = 5 * x4;
      const Scalar x11 = x1 * x4;
      out[0] = -x9 * (x3 * x5 + x5 * x6 + x7 * x[0] + x8);
      out[1] = -x9 * x[0] * (x10 * x3 + x10 * x6 + x7);
      out[2] = -125.0 / 6.0 * x[0] * (x11 * x3 + x11 * x6 + x7 * x[2] + x8);
      break;
    case 41:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = x0 - 1;
    ...
    case 42:
      ...
      const Scalar x4 = x2 * x3;
      const Scalar x5 = x4 * x[2];
      const Scalar x6 = (125.0 / 6.0) * x[0];
      const Scalar x7 = x0 + x[0];
      const Scalar x8 = x1 * x7;
      out[0] = -125.0 / 6.0 * x5 * (x0 + 2 * x[0]);
      out[1] = -x5 * x6;
      out[2] = -x6 * (x2 * x8 + x3 * x8 + x4 * x7 + x5);
      break;
    case 43:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 5 * x[0];
      const Scalar x2 = x1 - 1;
      const Scalar x3 = 5 * x[2];
      const Scalar x4 = x1 + x3 + 5 * x[1] - 4;
      const Scalar x5 = x2 * x[0];
      const Scalar x6 = x0 * x4;
      const Scalar x7 = (125.0 / 4.0) * x[2];
      out[0] = x7 * (x0 * x1 * x2 + x1 * x6 + x2 * x6 + x4 * x5);
      out[1] = x5 * x7 * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      out[2] = (125.0 / 4.0) * x5 * (x0 * x3 + x4 * x[2] + x6);
      break;
    case 44:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = x0 - 1;
      ...
      out[0] = -x7 * (x0 * x3 + x1 * x3 + x2);
      out[1] = -x2 * x7;
      out[2] = -125.0 / 4.0 * x2 * (x3 * x4 + x3 * x5 + x6);
      break;
    case 45:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 5 * x[0];
      const Scalar x2 = 5 * x[2];
      const Scalar x3 = x1 + x2 + 5 * x[1] - 4;
      const Scalar x4 = x0 * x3;
      const Scalar x5 = x2 - 1;
      const Scalar x6 = x5 * x[2];
      const Scalar x7 = (125.0 / 4.0) * x[0];
      out[0] = (125.0 / 4.0) * x6 * (x0 * x1 + x3 * x[0] + x4);
      out[1] = x6 * x7 * (10 * x[0] + 10 * x[1] + 10 * x[2] - 9);
      out[2] = x7 * (x0 * x2 * x5 + x2 * x4 + x3 * x6 + x4 * x5);
      break;
    case 46:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = x0 - 2;
      const Scalar x2 = x0 - 1;
      const Scalar x3 = x1 * x2;
      const Scalar x4 = (125.0 / 6.0) * x[2];
      const Scalar x5 = x3 * x[0];
      out[0] = x4 * x[1] * (x0 * x1 + x0 * x2 + x3);
      out[1] = x4 * x5;
      out[2] = (125.0 / 6.0) * x5 * x[1];
      break;
    case 47:
      const Scalar x0 = (125.0 / 6.0) * x[2];
      const Scalar x1 = 5 * x[1];
      ...
      const Scalar x5 = x4 * x[1];
      out[0] = x0 * x5;
      out[1] = x0 * x[0] * (x1 * x2 + x1 * x3 + x4);
      out[2] = (125.0 / 6.0) * x5 * x[0];
      break;
    case 48:
      const Scalar x0 = (125.0 / 6.0) * x[1];
      const Scalar x1 = 5 * x[2];
      const Scalar x2 = x1 - 2;
      const Scalar x3 = x1 - 1;
      const Scalar x4 = x2 * x3;
      const Scalar x5 = x4 * x[2];
      out[0] = x0 * x5;
      out[1] = (125.0 / 6.0) * x5 * x[0];
      out[2] = x0 * x[0] * (x1 * x2 + x1 * x3 + x4);
      break;
    case 49:
      const Scalar x0 = (125.0 / 4.0) * x[2];
      const Scalar x1 = x[1] * (5 * x[1] - 1);
      const Scalar x2 = x[0] * (5 * x[0] - 1);
      out[0] = x0 * x1 * (10 * x[0] - 1);
      out[1] = x0 * x2 * (10 * x[1] - 1);
      out[2] = (125.0 / 4.0) * x1 * x2;
      break;
    case 50:
      const Scalar x0 = (125.0 / 4.0) * x[2] * (5 * x[2] - 1);
      const Scalar x1 = x[1] * (5 * x[1] - 1);
      out[0] = x0 * x1;
      out[1] = x0 * x[0] * (10 * x[1] - 1);
      out[2] = (125.0 / 4.0) * x1 * x[0] * (10 * x[2] - 1);
      break;
    case 51:
      const Scalar x0 = (125.0 / 4.0) * x[1];
      const Scalar x1 = x[2] * (5 * x[2] - 1);
      const Scalar x2 = x[0] * (5 * x[0] - 1);
      out[0] = x0 * x1 * (10 * x[0] - 1);
      out[1] = (125.0 / 4.0) * x1 * x2;
      out[2] = x0 * x2 * (10 * x[2] - 1);
      break;
    case 52:
      const Scalar x0 = x[0] + x[1] + x[2] - 1;
      const Scalar x1 = 5 * x[0];
      const Scalar x2 = 5 * x[1];
      const Scalar x3 = 5 * x[2];
      const Scalar x4 = x1 + x2 + x3 - 4;
      const Scalar x5 = x0 * x4;
      const Scalar x6 = (625.0 / 2.0) * x[2];
      out[0] = x6 * x[1] * (x0 * x1 + x4 * x[0] + x5);
      out[1] = x6 * x[0] * (x0 * x2 + x4 * x[1] + x5);
      out[2] = (625.0 / 2.0) * x[0] * x[1] * (x0 * x3 + x4 * x[2] + x5);
      break;
    case 53:
      const Scalar x0 = 5 * x[0];
      const Scalar x1 = x0 - 1;
      const Scalar x2 = x1 * x[0];
      const Scalar x3 = x[0] + x[2] - 1;
      const Scalar x4 = x3 + x[1];
      const Scalar x5 = (625.0 / 2.0) * x[2];
      out[0] = -x5 * x[1] * (x0 * x4 + x1 * x4 + x2);
      out[1] = -x2 * x5 * (x3 + 2 * x[1]);
      out[2] = -625.0 / 2.0 * x2 * x[1] * (x[0] + x[1] + 2 * x[2] - 1);
      break;
    case 54:
      const Scalar x0 = x[1] - 1;
      const Scalar x1 = x0 + x[2];
      ...
      out[0] = -x4 * x5 * (x1 + 2 * x[0]);
      out[1] = -x5 * x[0] * (x2 * x6 + x3 * x6 + x4);
      out[2] = -625.0 / 2.0 * x4 * x[0] * (x0 + x[0] + 2 * x[2]);
      break;
    case 55:
      const Scalar x0 = x[2] - 1;
      const Scalar x1 = x0 + x[1];
      const Scalar x2 = 5 * x[2];
      const Scalar x3 = x2 - 1;
      const Scalar x4 = x3 * x[2];
      const Scalar x5 = (625.0 / 2.0) * x[1];
      const Scalar x6 = x1 + x[0];
      out[0] = -x4 * x5 * (x1 + 2 * x[0]);
      out[1] = -625.0 / 2.0 * x4 * x[0] * (x0 + x[0] + 2 * x[1]);
      out[2] = -x5 * x[0] * (x2 * x6 + x3 * x6 + x4);
      break;
    default:
      break;
    }
